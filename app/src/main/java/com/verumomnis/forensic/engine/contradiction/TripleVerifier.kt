...
/**
 * Triple Verifier & Report Generator — v5.2.9.
...
object TripleVerifier {
    ...
    private fun generateText(report: EngineForensicReport): String = buildString {
        ...
        appendLine("Engine: v5.2.9 | Constitution: v5.2.7")
        appendLine()
        ...
        appendLine().appendLine("=".repeat(70))
        appendLine("END OF REPORT — Seal: VO-CE-v529 | Constitution: v5.2.7")
        appendLine("=".repeat(70))
    }
    ...
    private fun generateMarkdown(report: EngineForensicReport): String = buildString {
        ...
        appendLine("*Generated by Verum Omnis Contradiction Engine v5.2.9 under Constitution v5.2.7*")
    }
}
